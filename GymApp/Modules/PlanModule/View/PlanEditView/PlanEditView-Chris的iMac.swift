...
class PlanEditView: UITableViewController, UITextFieldDelegate {
    ...
    let listPresenter: PlanEditPresenterProtocol
...
//        tf.text = "PlanTitle"
    ...
    init(listPresenter: PlanEditPresenterProtocol) {
...
//                    cell.valueTF.text = String(plan!.sectionList[indexPath.section-1].rowList[indexPath.row/2-1].value)
//                    cell.timesTF.text = String(plan!.sectionList[indexPath.section-1].rowList[indexPath.row/2-1].times)
                    cell.valueTF.text = String(plan!.sectionList[indexPath.section-1].rowList[(indexPath.row-1)/2].value)
                    cell.timesTF.text = String(plan!.sectionList[indexPath.section-1].rowList[(indexPath.row-1)/2].times)
                } else {
                    cell.valueTF.text = "-"
                    cell.timesTF.text = "-"
                }
...
extension PlanEditView: PlanEditViewProtocol {
    func reloadData() {
